...
SENSOR_STATE: dict[str, dict[str, Any]] = {
    "SENSOR-RES-001": {
        ...
        "location": {
            "latitude": -23.5505,
            "longitude": -46.6333,
            "descricao": "Piscinao Norte",
        },
    },
    "SENSOR-RES-002": {
        "sensor_id": "SENSOR-RES-002",
        "kind": "water",
        "label": "Sensor de Nivel 2",
        ...
        "location": {
            "latitude": -23.5510,
            "longitude": -46.6338,
            "descricao": "Piscinao Sul",
        },
    },
    "ESTACAO-MET-001": {
        "sensor_id": "ESTACAO-MET-001",
        "kind": "weather",
        "label": "Estacao Meteorologica 1",
        "values": {
            "vento_direcao": 180,
        ...
        "location": {
            "latitude": -23.5499,
            "longitude": -46.6325,
            "descricao": "Estacao Oeste",
        },
    },
    "ESTACAO-MET-002": {
        "sensor_id": "ESTACAO-MET-002",
        "kind": "weather",
        "label": "Estacao Meteorologica 2",
        "values": {
            "vento_direcao": 122,
